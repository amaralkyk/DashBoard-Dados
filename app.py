...
senioridades_selecionadas = st.sidebar.multiselect("senioridade",
                                                   senioridades_disponiveis,
                                                   default=senioridades_disponiveis
                                                )

contratos_disponiveis = sorted(df["contrato"].unique())
contratos_selecionados = st.sidebar.multiselect("contrato",
                                                contratos_disponiveis,
                                                default=contratos_disponiveis
                                            )

tamanhos_disponiveis = sorted(df["tamanho_empresa"].unique())
tamanhos_selecionados = st.sidebar.multiselect("tamanho_empresa",
...
with col_graf1:
    if not df_filtrado.empty:
        ...
        grafico_cargos = px.bar(
            ...
            y= "cargo",
            orientation= "h",
            title= "Top 10 cargos po salário médio",
            labels= {
